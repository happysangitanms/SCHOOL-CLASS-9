...
const MEDIA_CONFIG = {
    audio1: "https://audio.evidya.de/S9SSH1P1-2.mp3",
    video:  "https://www.youtube.com/embed/JaW2P3OBDg4?playsinline=1&rel=0&modestbranding=1&autoplay=1",
    pdf:    "https://audio.evidya.de/S9SSH1P1-2.pdf"
};
